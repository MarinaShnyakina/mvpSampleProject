    ...
    class LoadUsersTask extends AsyncTask<Void, Void, List<User>> {
        ...
        protected List<User> doInBackground(Void... params) {
            ...
            while (cursor.moveToNext()) {
                ...
                user.setId(cursor.getLong(cursor.getColumnIndexOrThrow(UserTable.COLUMN.ID)));
                user.setName(cursor.getString(cursor.getColumnIndexOrThrow(UserTable.COLUMN.NAME)));
                user.setEmail(cursor.getString(cursor.getColumnIndexOrThrow(UserTable.COLUMN.EMAIL)));
                users.add(user);
            }
            cursor.close();
            return users;
